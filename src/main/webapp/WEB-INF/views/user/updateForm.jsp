	...
	<div class="container">
		<form>
			...
			<div class="form-group">
				<label for="username">User Name:</label> <input type="text" class="form-control" placeholder="Enter user name" id="username" readonly="readonly" value="${principal.user.username }">
			</div>
